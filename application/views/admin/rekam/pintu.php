...
<div class="space-y-6">
  ...
  <section class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-brand-card">
  ...
  <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
    <?php foreach ($domain as $d): ?>
      <a href="<?= base_url($d['url']) ?>"
         class="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-colors hover:border-blue-300 dark:border-white/5 dark:bg-brand-card dark:hover:border-brand-primary/30">
