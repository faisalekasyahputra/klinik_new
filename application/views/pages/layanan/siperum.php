<!-- application/views/pages/layanan/siperum.php -->
<style>
...
<section class="w-full pt-16 pb-16 px-4 sm:px-6 lg:px-8 relative min-h-screen font-outfit">
    ...
    <div class="max-w-7xl mx-auto relative z-10">
        ...
        <nav class="flex items-center gap-2.5 text-xs md:text-sm text-[#8aacb0] font-medium mb-8 animate-fade-in-up delay-100" aria-label="Breadcrumb">
            ...
            <i class="fa-solid fa-chevron-right text-[8px] opacity-40"></i>
            <span class="text-white">Siperum</span>
        </nav>

        <!-- Dummy Content -->
        <div class="dark-bento-container shadow-2xl p-8 md:p-12 text-center animate-fade-in-up delay-200">
            <div class="w-24 h-24 rounded-full bg-[#00a3b5]/10 text-[#00a3b5] flex items-center justify-center mx-auto mb-6">
                <i class="fa-solid fa-building text-4xl"></i>
            </div>
            <h1 class="text-3xl md:text-4xl font-black text-[#00a3b5] mb-4">Siperum</h1>
            <p class="text-[#8aacb0] max-w-2xl mx-auto mb-8 leading-relaxed">
                Halaman Sistem Informasi Perumahan (Siperum) masih dalam tahap persiapan data dan integrasi. Segera hadir untuk memberikan kemudahan akses informasi perumahan.
            </p>
            <a href="<?= base_url() ?>" class="btn-cyan inline-flex items-center gap-2 px-8 py-3 rounded-full">
