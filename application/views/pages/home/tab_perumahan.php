...
<div class="py-4 sm:py-6 px-1 sm:px-2">
    <div class="flex items-center gap-2 mb-3">
        <i class="fa-solid fa-house-chimney  text-[#0f2a30]"></i>
        ...
        <a href="<?= base_url() ?>#etalase-program" data-tab-link data-tab-key="etalase" data-tab-group="perumahan"
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(0, 80, 95, 0.08); box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); min-height: 120px;">
            ...
            <div class="relative z-10">
                ...
                <h4 class="text-[#0f2a30] font-bold text-sm mb-1 group-hover:text-[#0f2a30] transition-colors">Etalase Program</h4>
                <p class="text-[#5a8a92] text-xs leading-relaxed">Daftar program bantuan & subsidi perumahan</p>
            </div>
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(0, 80, 95, 0.08); box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); min-height: 120px;">
            ...
            <div class="relative z-10">
                <i class="fa-solid fa-calculator mb-2.5 transition-transform duration-500 group-hover:scale-110"
                   style="font-size: 24px; color: #0f2a30; "></i>
                <h4 class="text-[#0f2a30] font-bold text-sm mb-1 group-hover:text-[#0f2a30] transition-colors">Info KPR & Subsidi</h4>
                <p class="text-[#5a8a92] text-xs leading-relaxed">Simulasi kredit dan informasi subsidi perumahan</p>
            </div>
            <div class="relative z-10 mt-auto pt-2.5">
                <div class="tl-btn-base" style="background-color: rgba(15,42,48,0.05); color: #0f2a30; border: 1px solid rgba(15,42,48,0.1);">
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(0, 80, 95, 0.08); box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); min-height: 120px;">
            ...
            <div class="relative z-10">
                <i class="fa-solid fa-pen-ruler mb-2.5 transition-transform duration-500 group-hover:scale-110"
                   style="font-size: 24px; color: #0f2a30; "></i>
                <h4 class="text-[#0f2a30] font-bold text-sm mb-1 group-hover:text-[#0f2a30] transition-colors">Bank Desain Rumah</h4>
                <p class="text-[#5a8a92] text-xs leading-relaxed">Prototipe desain rumah dari katalog Ternak Web</p>
            </div>
            <div class="relative z-10 mt-auto pt-2.5">
                <div class="tl-btn-base" style="background-color: rgba(15,42,48,0.05); color: #0f2a30; border: 1px solid rgba(15,42,48,0.1);">
