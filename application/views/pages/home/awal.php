...
<section class="w-full relative pt-20 pb-10 px-4 sm:px-6 lg:px-8 min-h-screen">

    <!-- Batik Kawung background, di halaman belakang (bukan di dalam wadah) -->
    <div class="absolute inset-0 pointer-events-none z-0" style="opacity: 0.08; mask-image: linear-gradient(to bottom, transparent 0%, black 12%, black 100%); -webkit-mask-image: linear-gradient(to bottom, transparent 0%, black 12%, black 100%);">
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <pattern id="batik-home-portal" x="0" y="0" width="100" height="100" patternUnits="userSpaceOnUse">
            ...
            <rect width="100%" height="100%" fill="url(#batik-home-portal)" />
        </svg>
    </div>

    <div class="w-full relative z-10">

        <!-- Tab bar — DI LUAR wadah, nempel di atasnya (ala browser tab) -->
        <div class="flex items-stretch gap-1.5 px-2 sm:px-3 overflow-x-auto no-scrollbar">
            <a href="#menu-utama" class="flex items-center gap-2 px-5 py-3 rounded-t-2xl text-xs sm:text-sm font-bold whitespace-nowrap transition-colors" style="background-color: var(--bg-card); color: #d6fb00; border: 1px solid rgba(255,255,255,0.08); border-bottom: none;">
                <i class="fa-solid fa-grip"></i> Menu Utama
            </a>
            <a href="#etalase-program" class="flex items-center gap-2 px-5 py-3 rounded-t-2xl text-xs sm:text-sm font-semibold text-[#8aacb0] hover:text-white whitespace-nowrap transition-colors" style="background-color: rgba(255,255,255,0.03);">
                <i class="fa-solid fa-house-chimney-window"></i> Program
            </a>
            <a href="#akses-cepat" class="flex items-center gap-2 px-5 py-3 rounded-t-2xl text-xs sm:text-sm font-semibold text-[#8aacb0] hover:text-white whitespace-nowrap transition-colors" style="background-color: rgba(255,255,255,0.03);">
                <i class="fa-solid fa-bolt"></i> Akses Cepat
            </a>
        </div>

        <!-- Wadah utama -->
        <div class="w-full rounded-b-[2.5rem] sm:rounded-b-[3rem] rounded-tr-[2.5rem] sm:rounded-tr-[3rem] p-4 sm:p-6 lg:p-7 overflow-hidden" style="background-color: var(--bg-card); border: 1px solid rgba(255,255,255,0.08); box-shadow: 0 20px 60px rgba(0,0,0,0.35);">
        ...
        <!-- ============================================================
             ...
             ============================================================ -->
        <div id="menu-utama" class="mb-3 scroll-mt-24">
        ...
        <!-- ============================================================
             ...
             ============================================================ -->
        <div id="etalase-program" class="mb-3 scroll-mt-24">
        ...
        <!-- ============================================================
             ...
             ============================================================ -->
        <div id="akses-cepat" class="mb-3 scroll-mt-24">
