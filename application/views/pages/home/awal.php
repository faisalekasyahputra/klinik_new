...
<section class="w-full relative overflow-hidden" style="height: 100vh" x-data="heroSlider()">
    ...
    <div class="hero-slide" :class="current === 2 && 'active'">
        <div class="absolute inset-0 gradient-hero z-10"></div>
        <picture>
            <source srcset="<?= base_url('assets/img/hero/hero-permukiman-prambanan.webp') ?>" type="image/webp">
            <img src="<?= base_url('assets/img/hero/hero-permukiman-prambanan-opt.jpeg') ?>" alt="Permukiman padat penduduk di sekitar Candi Prambanan Jawa Tengah dari udara" loading="lazy">
        </picture>
        <div class="absolute inset-0 z-20 max-w-7xl mx-auto px-6 lg:px-8 flex flex-col justify-center">
            <div class="max-w-2xl animate-fade-in-up">
                ...
                <a href="https://my.pkp.go.id/cekbantuan" target="_blank" class="inline-flex btn-emerald text-xs px-6 py-3.5 rounded-xl items-center gap-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="bento-card">
                ...
                <div class="bento-grid">
                    <!-- Dashed Dividers -->
                    <div class="bento-divider-h"></div>
                    <div class="bento-divider-v"></div>

                    <!-- Card 1: Layanan Digital (Lime) -->
                    <div class="unified-stat-group flex flex-col items-center text-center cursor-default transition-all duration-300">
                        <i class="stat-icon fa-solid fa-house-laptop mb-4 text-[#d6fb00] transition-transform duration-300" style="font-size: 2.25rem; filter: drop-shadow(0 0 10px rgba(214,251,0,0.4));"></i>
                        <h4 class="stat-num stat-lime text-white font-bold mb-1 transition-all duration-300" style="font-size: 2.5rem; line-height: 1;">4</h4>
                        <p class="text-zinc-400 group-hover:text-zinc-300 uppercase tracking-widest font-semibold transition-colors mt-2" style="font-size: 0.65rem;">Layanan Digital</p>
                    </div>
                    
                    <!-- Card 2: Kabupaten/Kota (Cyan) -->
                    <div class="unified-stat-group flex flex-col items-center text-center cursor-default transition-all duration-300">
                        <i class="stat-icon fa-solid fa-map-location-dot mb-4 text-[#00a3b5] transition-transform duration-300" style="font-size: 2.25rem; filter: drop-shadow(0 0 10px rgba(0,163,181,0.4));"></i>
                        <h4 class="stat-num stat-cyan text-white font-bold mb-1 transition-all duration-300" style="font-size: 2.5rem; line-height: 1;">35</h4>
                        <p class="text-zinc-400 group-hover:text-zinc-300 uppercase tracking-widest font-semibold transition-colors mt-2" style="font-size: 0.65rem;">Kabupaten/Kota</p>
                    </div>
                    
                    <!-- Card 3: Warga Terlayani (Green) -->
                    <div class="unified-stat-group flex flex-col items-center text-center cursor-default transition-all duration-300">
                        <i class="stat-icon fa-solid fa-users mb-4 text-[#6bcb77] transition-transform duration-300" style="font-size: 2.25rem; filter: drop-shadow(0 0 10px rgba(107,203,119,0.4));"></i>
                        <h4 class="stat-num stat-green text-white font-bold mb-1 transition-all duration-300" style="font-size: 2.5rem; line-height: 1;">12K+</h4>
                        <p class="text-zinc-400 group-hover:text-zinc-300 uppercase tracking-widest font-semibold transition-colors mt-2" style="font-size: 0.65rem;">Warga Terlayani</p>
                    </div>
                    
                    <!-- Card 4: Akses Online (Purple) -->
                    <div class="unified-stat-group flex flex-col items-center text-center cursor-default transition-all duration-300">
                        <i class="stat-icon fa-solid fa-clock mb-4 text-[#c084fc] transition-transform duration-300" style="font-size: 2.25rem; filter: drop-shadow(0 0 10px rgba(192,132,252,0.4));"></i>
                        <h4 class="stat-num stat-purple text-white font-bold mb-1 transition-all duration-300" style="font-size: 2.5rem; line-height: 1;">24/7</h4>
                        <p class="text-zinc-400 group-hover:text-zinc-300 uppercase tracking-widest font-semibold transition-colors mt-2" style="font-size: 0.65rem;">Akses Online</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <style>
            ...
            @media (min-width: 768px) {
                ...
                .tl-dot { left: 50%; transform: translate(-50%, -50%); }
            ...
            /* Absolute Positioning Fixes for Lines */
        ...
        <div class="relative">
            <div class="flex flex-col">
                ...
                <div class="relative flex flex-col md:flex-row items-center w-full <?= $isEven ? 'tl-justify-start' : 'tl-justify-end' ?> py-5 md:py-0 tl-row group">
                    ...
                    <!-- Garis Atas (Hanya jika bukan step pertama) -->
                    <?php if ($index !== 0): ?>
                    <div class="absolute border-l-2 border-dashed z-0 transition-colors duration-500 tl-line-v tl-line-top tl-line-border"></div>
                    <?php endif; ?>
                    
                    <!-- Garis Bawah (Hanya jika bukan step terakhir) -->
                    <?php if ($index !== $totalSteps - 1): ?>
                    <div class="absolute border-l-2 border-dashed z-0 transition-colors duration-500 tl-line-v tl-line-bottom tl-line-border"></div>
                    <?php endif; ?>

                    <!-- Garis Penghubung Horizontal (Desktop Only) -->
                    <div class="hidden md:block absolute top-1/2 border-t-2 border-dashed z-0 transition-colors duration-500 tl-line-border <?= $isEven ? 'tl-line-h-right' : 'tl-line-h-left' ?>"></div>
                    
                    <!-- Titik Pipeline -->
                    <div class="absolute top-1/2 -translate-y-1/2 w-6 h-6 rounded-full border-2 bg-[#0a1a1f] z-10 transition-all duration-500 tl-line-border tl-dot"></div>

                    <!-- Pembungkus Kartu -->
                    <div class="pl-16 md:pl-0 <?= $isEven ? 'tl-pr-14' : 'tl-pl-14' ?> tl-card-wrap">
                        <!-- Kartu -->
                        <div class="relative tl-mesh-bg border border-[#d6fb00]/20 rounded-2xl p-6 md:p-8 transition-all duration-500 overflow-hidden hover:-translate-y-2 hover:border-[#d6fb00]/35 h-full tl-card-inner">
...
<section id="cari-perumahan" class="w-full py-20 sm:py-28 scroll-mt-20">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="border p-6 sm:p-8 rounded-3xl mb-10 backdrop-blur-md" style="background-color: rgba(15, 42, 48, 0.7); border-color: rgba(214, 251, 0, 0.15);">
