<!-- ============================================================
     ARSIP: Hero full-viewport (title + bg slideshow), Quick Links
     card version, dan Etalase Program carousel interaktif
     ============================================================
     ...
     Isi file ini (3 bagian independen):
       ...
       3. ETALASE PROGRAM (CAROUSEL) - carousel banner geser dengan
          ...
          (id="etalase-program" tetap dipertahankan untuk anchor link
          dari menu navigasi).
...
<!-- ================= BAGIAN 3: ETALASE PROGRAM (CAROUSEL) ================= -->
<!-- ============================================================
