    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
        ...
        <a href="<?= base_url('Pengembang/sertifikasi') ?>" data-tab-link data-tab-key="pengembang_list" data-tab-group="pengembang"
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(214,251,0, 0.15); box-shadow: 0 4px 20px rgba(0,0,0,0.2); min-height: 168px;">
            ...
            <div class="relative z-10">
                <i class="fa-solid fa-users mb-4 transition-transform duration-500 group-hover:scale-110"
                   style="font-size: 32px; color: #d6fb00; filter: drop-shadow(0 0 12px rgba(214,251,0, 0.4));"></i>
                <h4 class="text-white font-bold text-lg mb-1.5 group-hover:text-[#d6fb00] transition-colors">Daftar Pengembang Tersertifikasi</h4>
        ...
        <a href="<?= base_url('Pengembang/syarat') ?>" data-tab-link data-tab-key="pengembang_syarat" data-tab-group="pengembang"
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(0,163,181, 0.15); box-shadow: 0 4px 20px rgba(0,0,0,0.2); min-height: 168px;">
            ...
            <div class="relative z-10">
                <i class="fa-solid fa-clipboard-list mb-4 transition-transform duration-500 group-hover:scale-110"
                   style="font-size: 32px; color: #00a3b5; filter: drop-shadow(0 0 12px rgba(0,163,181, 0.4));"></i>
                <h4 class="text-white font-bold text-lg mb-1.5 group-hover:text-[#00a3b5] transition-colors">Syarat & Ketentuan SRP2</h4>
        ...
        <a href="<?= base_url('Pengembang/formulir') ?>" data-tab-link data-tab-key="pengembang_formulir" data-tab-group="pengembang"
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(107,203,119, 0.15); box-shadow: 0 4px 20px rgba(0,0,0,0.2); min-height: 168px;">
            ...
            <div class="relative z-10">
                <i class="fa-solid fa-file-signature mb-4 transition-transform duration-500 group-hover:scale-110"
                   style="font-size: 32px; color: #6bcb77; filter: drop-shadow(0 0 12px rgba(107,203,119, 0.4));"></i>
                <h4 class="text-white font-bold text-lg mb-1.5 group-hover:text-[#6bcb77] transition-colors">Formulir Pendaftaran SRP2</h4>
