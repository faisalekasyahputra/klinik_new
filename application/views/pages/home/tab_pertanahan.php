    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
        ...
        <a href="<?= base_url('info_tanah') ?>" data-tab-link data-tab-key="info_tanah" data-tab-group="pertanahan"
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(0,163,181, 0.15); box-shadow: 0 4px 20px rgba(0,0,0,0.2); min-height: 168px;">
            ...
            <div class="relative z-10">
                <i class="fa-solid fa-file-circle-check mb-4 transition-transform duration-500 group-hover:scale-110"
                   style="font-size: 32px; color: #00a3b5; filter: drop-shadow(0 0 12px rgba(0,163,181, 0.4));"></i>
                <h4 class="text-white font-bold text-lg mb-1.5 group-hover:text-[#00a3b5] transition-colors">Informasi Status Tanah</h4>
        ...
        <a href="<?= base_url('sertifikasi') ?>" data-tab-link data-tab-key="sertifikasi_tanah" data-tab-group="pertanahan"
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(214,251,0, 0.15); box-shadow: 0 4px 20px rgba(0,0,0,0.2); min-height: 168px;">
            ...
            <div class="relative z-10">
                <i class="fa-solid fa-stamp mb-4 transition-transform duration-500 group-hover:scale-110"
                   style="font-size: 32px; color: #d6fb00; filter: drop-shadow(0 0 12px rgba(214,251,0, 0.4));"></i>
                <h4 class="text-white font-bold text-lg mb-1.5 group-hover:text-[#d6fb00] transition-colors">Sertifikasi Lahan Perumahan</h4>
        ...
        <a href="<?= base_url('sengketa') ?>" data-tab-link data-tab-key="sengketa" data-tab-group="pertanahan"
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(245,158,11, 0.15); box-shadow: 0 4px 20px rgba(0,0,0,0.2); min-height: 168px;">
            ...
            <div class="relative z-10">
                <i class="fa-solid fa-gavel mb-4 transition-transform duration-500 group-hover:scale-110"
                   style="font-size: 32px; color: #f59e0b; filter: drop-shadow(0 0 12px rgba(245,158,11, 0.4));"></i>
                <h4 class="text-white font-bold text-lg mb-1.5 group-hover:text-[#f59e0b] transition-colors">Penyelesaian Sengketa</h4>
        ...
        <a href="<?= base_url('bank_tanah') ?>" data-tab-link data-tab-key="bank_tanah" data-tab-group="pertanahan"
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(107,203,119, 0.15); box-shadow: 0 4px 20px rgba(0,0,0,0.2); min-height: 168px;">
            ...
            <div class="relative z-10">
                <i class="fa-solid fa-mountain-sun mb-4 transition-transform duration-500 group-hover:scale-110"
                   style="font-size: 32px; color: #6bcb77; filter: drop-shadow(0 0 12px rgba(107,203,119, 0.4));"></i>
                <h4 class="text-white font-bold text-lg mb-1.5 group-hover:text-[#6bcb77] transition-colors">Bank Tanah (Land Bank)</h4>
