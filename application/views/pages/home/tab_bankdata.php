...
<div class="py-4 sm:py-6 px-1 sm:px-2">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
        ...
        <a href="<?= base_url('Statistika') ?>" data-tab-link data-tab-key="statistika" data-tab-group="bankdata"
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(214,251,0, 0.15); box-shadow: 0 4px 20px rgba(0,0,0,0.2); min-height: 120px;">
            ...
            <div class="relative z-10">
                ...
                <h4 class="text-white font-bold text-sm mb-1 group-hover:text-[#d6fb00] transition-colors">Statistik & Grafik</h4>
        ...
        <div title="Segera Hadir"
             ...
             style="background-color: var(--bg-card); border: 1px solid rgba(138,172,176, 0.15); box-shadow: 0 4px 20px rgba(0,0,0,0.2); min-height: 120px;">
            <i class="fa-solid fa-database absolute pointer-events-none"
               style="font-size: 80px; right: -1rem; bottom: -1rem; color: #8aacb0; opacity: 0.06;"></i>
            <div class="relative z-10">
                <i class="fa-solid fa-database mb-2.5"
                   style="font-size: 24px; color: #8aacb0; filter: drop-shadow(0 0 12px rgba(138,172,176, 0.4));"></i>
                <h4 class="text-white font-bold text-sm mb-1">Data Lainnya</h4>
