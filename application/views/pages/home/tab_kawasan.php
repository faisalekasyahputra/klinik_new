        ...
        <a href="<?= base_url('sebaran') ?>" data-tab-link data-tab-key="sebaran" data-tab-group="kawasan"
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(245,158,11, 0.15); box-shadow: 0 4px 20px rgba(0,0,0,0.2); min-height: 120px;">
            ...
            <div class="relative z-10">
                ...
                <h4 class="text-white font-bold text-sm mb-1 group-hover:text-[#f59e0b] transition-colors">Sebaran RTLH</h4>
        ...
        <a href="<?= base_url('sebaran_rusun') ?>" data-tab-link data-tab-key="sebaran_rusun" data-tab-group="kawasan"
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(0,163,181, 0.15); box-shadow: 0 4px 20px rgba(0,0,0,0.2); min-height: 120px;">
            ...
            <div class="relative z-10">
                ...
                <h4 class="text-white font-bold text-sm mb-1 group-hover:text-[#00a3b5] transition-colors">Sebaran Rusun</h4>
        ...
        <a href="<?= base_url('profil_kumuh') ?>" data-tab-link data-tab-key="profil_kumuh" data-tab-group="kawasan"
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(214,251,0, 0.15); box-shadow: 0 4px 20px rgba(0,0,0,0.2); min-height: 120px;">
            ...
            <div class="relative z-10">
                ...
                <h4 class="text-white font-bold text-sm mb-1 group-hover:text-[#d6fb00] transition-colors">Profil Kawasan Kumuh</h4>
        ...
        <a href="<?= base_url('sebaran_sdgs') ?>" data-tab-link data-tab-key="sebaran_sdgs" data-tab-group="kawasan"
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(107,203,119, 0.15); box-shadow: 0 4px 20px rgba(0,0,0,0.2); min-height: 120px;">
            ...
            <div class="relative z-10">
                ...
                <h4 class="text-white font-bold text-sm mb-1 group-hover:text-[#6bcb77] transition-colors">Sebaran Bantuan SDGS</h4>
