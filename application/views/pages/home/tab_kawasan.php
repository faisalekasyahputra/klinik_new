...
<div class="py-4 sm:py-6 px-1 sm:px-2">
    <div class="flex items-center gap-2 mb-3">
        <i class="fa-solid fa-city  text-[#0f2a30]"></i>
        ...
        <a href="<?= base_url('sebaran') ?>" data-tab-link data-tab-key="sebaran" data-tab-group="kawasan"
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(0, 80, 95, 0.08); box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); min-height: 120px;">
            ...
            <div class="relative z-10">
                ...
                <h4 class="text-[#0f2a30] font-bold text-sm mb-1 group-hover:text-[#0f2a30] transition-colors">Sebaran RTLH</h4>
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(0, 80, 95, 0.08); box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); min-height: 120px;">
            ...
            <div class="relative z-10">
                <i class="fa-solid fa-building mb-2.5 transition-transform duration-500 group-hover:scale-110"
                   style="font-size: 24px; color: #0f2a30; "></i>
                <h4 class="text-[#0f2a30] font-bold text-sm mb-1 group-hover:text-[#0f2a30] transition-colors">Sebaran Rusun</h4>
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(0, 80, 95, 0.08); box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); min-height: 120px;">
            ...
            <div class="relative z-10">
                <i class="fa-solid fa-city mb-2.5 transition-transform duration-500 group-hover:scale-110"
                   style="font-size: 24px; color: #0f2a30; "></i>
                <h4 class="text-[#0f2a30] font-bold text-sm mb-1 group-hover:text-[#0f2a30] transition-colors">Profil Kawasan Kumuh</h4>
           ...
           style="background-color: var(--bg-card); border: 1px solid rgba(0, 80, 95, 0.08); box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); min-height: 120px;">
            ...
            <div class="relative z-10">
                <i class="fa-solid fa-hand-holding-heart mb-2.5 transition-transform duration-500 group-hover:scale-110"
                   style="font-size: 24px; color: #0f2a30; "></i>
                <h4 class="text-[#0f2a30] font-bold text-sm mb-1 group-hover:text-[#0f2a30] transition-colors">Sebaran Bantuan SDGS</h4>
