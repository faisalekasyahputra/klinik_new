<section class="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch z-10 relative">
    ...
    <div class="bg-[#0b0c10]/75 border border-zinc-800/50 rounded-[2.5rem] p-6 sm:p-10 backdrop-blur-xl shadow-2xl flex flex-col justify-between">
        ...
        <div class="text-center mb-8">
            <span class="text-zinc-400 text-xs font-bold uppercase tracking-wider block mb-1">Menu</span>
    ...
    <div class="bg-[#0b0c10]/75 border border-zinc-800/50 rounded-[2.5rem] p-6 sm:p-10 backdrop-blur-xl shadow-2xl flex flex-col justify-between">
        ...
        <div>
            <div class="mb-4">
                <span class="inline-block bg-[#005e6a] text-white text-[10px] font-bold uppercase tracking-widest px-3 py-1 rounded-full">
                    Partner Bank
                </span>
            </div>
            ...
            <p class="text-zinc-400 text-xs sm:text-sm font-medium leading-relaxed mb-6">
                Ajukan estimasi perhitungan kredit kepemilikan rumah secara langsung melalui layanan perbankan mitra resmi kami di bawah ini:
            </p>
        </div>

        

      <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 items-center justify-items-center my-auto py-6 w-full">
          
          <a href="#" class="group w-full bg-gradient-to-br from-[#d6fb00] via-amber-400 to-amber-500 p-4 rounded-2xl border border-[#d6fb00]/20 flex items-center justify-center min-h-[70px] shadow-lg transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[#d6fb00]/20">
              <img src="https://upload.wikimedia.org/wikipedia/commons/5/5c/Bank_Central_Asia.svg" alt="BCA" class="h-7 w-full object-contain transition-transform duration-300 group-hover:scale-105">
          </a>

          <a href="#" class="group w-full bg-gradient-to-br from-[#d6fb00] via-amber-400 to-amber-500 p-4 rounded-2xl border border-[#d6fb00]/20 flex items-center justify-center min-h-[70px] shadow-lg transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[#d6fb00]/20">
              <img src="https://upload.wikimedia.org/wikipedia/commons/6/68/BANK_BRI_logo.svg" alt="BRI" class="h-6 w-full object-contain transition-transform duration-300 group-hover:scale-105">
          </a>

          <a href="#" class="group w-full bg-gradient-to-br from-[#d6fb00] via-amber-400 to-amber-500 p-4 rounded-2xl border border-[#d6fb00]/20 flex items-center justify-center min-h-[70px] shadow-lg transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[#d6fb00]/20">
              <img src="https://upload.wikimedia.org/wikipedia/commons/a/ad/Bank_Mandiri_logo_2016.svg" alt="Mandiri" class="h-5 w-full object-contain transition-transform duration-300 group-hover:scale-105">
          </a>

          <a href="#" class="group w-full bg-gradient-to-br from-[#d6fb00] via-amber-400 to-amber-500 p-4 rounded-2xl border border-[#d6fb00]/20 flex items-center justify-center min-h-[70px] shadow-lg transition-all duration-300 transform hover:-translate-y-1 hover:shadow-[#d6fb00]/20">
              <img src="<?=base_url('assets/img/btn.svg')?>" alt="BTN" class="h-6 w-full object-contain transition-transform duration-300 group-hover:scale-105">
          </a>
