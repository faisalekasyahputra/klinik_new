                    ...
                    <div class="py-3 text-center">
                        ...
                        <template x-if="!isPengelola">
                            <div>
                                ...
                                <a :href="baseUrl" class="mt-5 inline-flex items-center justify-center gap-2 rounded-lg px-5 py-2.5 text-[11px] font-extrabold uppercase tracking-wide" style="background:var(--portal-border);color:var(--portal-text)">Kembali ke Beranda</a>
                            </div>
                        </template>
                    </div>
                </template>
