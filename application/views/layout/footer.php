 <!-- ============================================================
     FOOTER
     ============================================================ -->
 <footer class="w-full bg-[#0a1a1f] text-zinc-400 pt-16 pb-6 mt-auto border-t border-[#d6fb00]/20 relative z-10">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12 pb-12 border-b border-[#d6fb00]/20">
            ...
            <div class="md:col-span-5 space-y-5">
                ...
                <div class="pt-1">
                    <span class="block text-[10px] font-bold text-zinc-500 uppercase tracking-wider mb-2">Kerjasama:</span>
                    <div class="flex items-center gap-2">
                        <div class="bg-[#d6fb00]/5 border border-[#d6fb00]/20 p-1.5 rounded-lg h-9 w-12 flex items-center justify-center">
                            <div class="w-6 h-6 rounded-full bg-[#d6fb00]/10 border border-[#d6fb00]/20 flex items-center justify-center text-[8px] font-bold text-[#d6fb00]">JTG</div>
                        </div>
                        <div class="bg-[#d6fb00]/5 border border-[#d6fb00]/20 px-2.5 rounded-lg h-9 flex items-center justify-center text-[10px] font-extrabold tracking-wider text-zinc-500">
                            <span class="text-[#d6fb00]">U</span>TDI
                        </div>
                    </div>
                </div>
            </div>
...
function globalSystem() { return { mobileMenu: false } }
</script>