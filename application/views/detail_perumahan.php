<section class="w-full bg-[#0a1a1f] py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto relative z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-10">
            ...
            <div class="lg:col-span-7 grid grid-cols-12 gap-3 h-72 md:h-[400px] w-full relative">
                ...
                <div class="col-span-8 relative bg-[#0f2a30] border border-[#d6fb00]/20 rounded-2xl overflow-hidden shadow-xl group">
                    <?php if (!empty($foto1)): 
                         $url_asli = $row['foto'][0]; 
                        ...
                        <img src="<?php echo base_url('Index/buka_foto'); ?>?path=<?= urlencode($path_bersih) ?>" class="w-full h-full object-cover" alt="Foto Utama Perumahan">
                    <?php else: ?>
                        <div class="w-full h-full flex flex-col items-center justify-center text-zinc-600 bg-[#0f2a30]">
                ...
                <div class="col-span-4 grid grid-rows-2 gap-3 h-full">
                    
                    <div class="relative bg-[#0f2a30] border border-[#d6fb00]/20 rounded-2xl overflow-hidden shadow-xl">
                        <?php if (!empty($foto2)): 
                            $url_asli = $row['foto'][1]; 
                            ...
                            // 3. Bersihkan tanda backslash (\) agar menjadi public/upload/...
                            $path_bersih = stripslashes($path_potong);?>
                            <img src="<?php echo base_url('Index/buka_foto'); ?>?path=<?= urlencode($path_bersih) ?>" class="w-full h-full object-cover" alt="Foto Unit Dalam">
                        <?php else: ?>
                            <div class="w-full h-full flex flex-col items-center justify-center text-zinc-600 bg-[#0f2a30]">
                    ...
                    <div class="relative bg-[#0f2a30] border border-[#d6fb00]/20 rounded-2xl overflow-hidden shadow-xl">
                        <?php if (!empty($foto3)): 
                            ...
                            $path_bersih = stripslashes($path_potong);
                            ?>
                            <img src="<?php echo base_url('Index/buka_foto'); ?>?path=<?= urlencode($path_bersih) ?>" class="w-full h-full object-cover" alt="Foto Fasilitas">
                        <?php else: ?>
                            <div class="w-full h-full flex flex-col items-center justify-center text-zinc-600 bg-[#0f2a30]">
                                <i class="fa-regular fa-image text-2xl mb-1"></i>
            ...
            <div class="lg:col-span-5 flex flex-col justify-center space-y-4">
                <span class="text-[#d6fb00] text-xs font-bold uppercase tracking-widest flex items-center gap-1.5">
                    <span class="w-2 h-2 bg-[#d6fb00] rounded-full animate-pulse"></span> Unit Terverifikasi
                </span>
