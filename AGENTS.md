...
12. **Kredensial demo di view: DIIZINKAN SELAMA MASA UJI COBA, dengan syarat.** Keputusan user 27 Jul 2026 — dinas sedang menguji sistem dan tanpa kredensial di layar mereka tidak bisa menelusuri keenam peran. Blok demo di `pages/auth/login.php` dan wizard SRP2 memang sengaja ada, **bukan kelalaian, jangan dihapus tanpa perintah baru**.
