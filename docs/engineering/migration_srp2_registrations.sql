...
CREATE TABLE IF NOT EXISTS `srp2_registrations` (
  ...
  `jabatan` VARCHAR(30) NOT NULL COMMENT 'direktur_utama|manajer_proyek|penanggung_jawab|staf_legal',
  `no_whatsapp` VARCHAR(15) NOT NULL,
  `email` VARCHAR(100) NOT NULL,
  `nama_perusahaan` VARCHAR(150) NOT NULL,
  `nib` VARCHAR(13) NOT NULL,
  `asosiasi` VARCHAR(30) NOT NULL COMMENT 'rei|himperra|apersi|pi|lainnya',
  `no_keanggotaan` VARCHAR(50) NOT NULL,
  `alamat_kantor` TEXT NOT NULL,
  `file_ktp` VARCHAR(255) NOT NULL,
  `file_kta` VARCHAR(255) NOT NULL,
  `file_nib` VARCHAR(255) NOT NULL,
