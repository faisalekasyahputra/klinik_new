...
| **I** (Information Disclosure) | Kebocoran data pribadi NIK dan Alamat lengkap pengguna yang tersimpan secara plaintext di database `usr_users`. | Terapkan enkripsi *at-rest* **AES-256-GCM** untuk NIK dan Alamat, dikombinasikan dengan *Deterministic Hashing* untuk deteksi keunikan akun. |
